    ...
    <div class="container" style="padding-top: 200px">
        ...
        <div class="row text-center mt-5">
            ...
            <div class="col-xl-4 col-sm-6 mb-5">
                <div class="bg-card rounded shadow-sm py-5 px-4">
                    <img src="images/beatriz.jpeg" alt="" width="100" class="img-fluid rounded mb-3 shadow-sm img-card">
                    <h5 class="mb-0">Beatriz <span style="color: #EDA011;">Egen</span></h5>
                    ...
                    <ul class="social mb-0 list-inline mt-3">
                        ...
                        <li class="list-inline-item">
                            <a href="https://github.com/egenbia" class="social-link">
            ...
            <div class="col-xl-4 col-sm-6 mb-5">
                <div class="bg-card rounded shadow-sm py-5 px-4">
                    <img src="images/isaac.jpeg" alt="" width="100" class="img-fluid rounded mb-3 shadow-sm">
                    <h5 class="mb-0">Isaac <span style="color: #EDA011;">Hideki</span></h5>
                    ...
                    <ul class="social mb-0 list-inline mt-3">
                        ...
                        <li class="list-inline-item">
                            <a href="https://github.com/gabrieelapl" class="social-link">
                                <i class="bi bi-github"></i>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="col-xl-4 col-sm-6 mb-5">
                <div class="bg-card rounded shadow-sm py-5 px-4">
                    <img src="images/gabriela.jpeg" alt="" width="100" class="img-fluid rounded mb-3 shadow-sm">
                    <h5 class="mb-0">Gabriela <span style="color: #EDA011;">Lino</span></h5>
        ...
        <div class="row text-center">
            <div class="col-xl-6 col-sm-6 mb-5">
                <div class="bg-card rounded shadow-sm py-5 px-4">
                    <img src="images/felipe.jpeg" alt="" width="100" class="img-fluid rounded mb-3 shadow-sm">
                    <h5 class="mb-0">Felipe <span style="color: #EDA011;">Zoraski</span></h5>
                    <span class="small text-uppercase">Programador Mobile</span>
                    <ul class="social mb-0 list-inline mt-3">
                        <li class="list-inline-item">
            ...
            <div class="col-xl-6 col-sm-6 mb-5">
                <div class="bg-card rounded shadow-sm py-5 px-4">
                    <img src="images/alcina.jpeg" alt="" width="100" class="img-fluid rounded mb-3 shadow-sm">
                    <h5 class="mb-0">Alcina <span style="color: #EDA011;">Freitas</span></h5>
                    <span class="small text-uppercase">Responsável pelo texto</span>
                    <ul class="social mb-0 list-inline mt-3">
                        <li class="list-inline-item">
